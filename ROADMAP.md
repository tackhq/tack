...
| [ ] | `wait_for` module | Poll for conditions before proceeding | Params: port, host, path, status_code, timeout, delay, state (started/stopped). Replaces fragile shell loops |
