...
| [x] | Dynamic inventory | External inventory sources beyond static YAML | Script/binary plugin (run command, parse JSON), built-in AWS EC2 plugin, generic HTTP source. Static YAML doesn't scale for cloud fleets |
